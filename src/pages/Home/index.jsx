              ...
              <Col sm={12} md={12} lg={12} xl={6} className="home-about-description">
                <Zoom>
                  ...
                  <p className="home-about-body">
                    ...
                    with expertise in full-stack development, DevOps, AI/GenAI integration (LLMs, RAG, AI agents), and system architecture. Currently serving as a
                    ...
                    <b className="yellow"> MongoDB, PostgreSQL, MySQL, DynamoDB, Firebase, and Supabase, </b>
